...
define(['text!./workflow.xml', 'text!./workflow.xaml'], function( htmlString, xamlString) { 
	/**
	 * CONSTRUCTOR
	 */
...
//debugger;	
		...
		this.readonly = params.parentContext().spaform.form.readonly;
		this.designmode = params.parentContext().spaform.runtime.designMode;
//		 
...
//console.log("obj =" + JSON.stringify(obj));			
			...
			var canEdit = this.spaform.user.userPermissions.has(SP.PermissionKind.editListItems);
...
//console.log("arr =" + JSON.stringify(arr));			
        ...
        this.buttonApproveClick = function () {	
			spaform.form.closeOnClick = this.closeFormOnButtonClick;
