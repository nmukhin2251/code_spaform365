...
//define(['text!./transition.xml', 'jsm-camelize'], function( htmlString, camelize) {
define(['text!./transition.xml'], function( htmlString) {	
...
// 		 * return d.promise();
// 		 * 
// 		 * Option 2: synchronous callback to cancel transition.
// 		 * 			 all subsequent lifecycle events will be cancelled and the state will remain unchanged.
// 		 * return false;
// 		 * 
// 		 * Option 3: synchronous callback to continue transition processing
// 		 * return true;
// 		 */
		var onBeforeClick = function(lifecycle) {
			...
			return true; // false - to cancel transition
		};
        ...
        this.click = function () {
			f.workflow.fsm[f.workflow.fsm.camelize(id)](f.state()); // trigger transition execution;
		};
    ...
    //componenttransition.prototype.doSomething = function() { ... };
	transition.prototype.schema = {
		"Params": {
			"namespace": "listItem",
			"visible": true,
			"Title": "transition",
    ...
    return { viewModel: transition, template: htmlString };
});
