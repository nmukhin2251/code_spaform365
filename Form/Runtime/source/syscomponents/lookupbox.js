...
define(['text!lookupbox.xml'], function( htmlString) {
	...
	function lookupbox( params) { 
		 ...
		 */
		this.value = ko.observable().extend({ namespace: params });//this.value = ko.observable().inNamespace( params.namespace, params.InternalName);//.extend({ listItem: this.internalName });
